...
export default function Project() {
  return (
    <div className="relative w-full min-h-screen overflow-x-hidden bg-gradient-to-br from-gray-50 to-gray-100">
        ...
        <div className="text-center max-w-3xl">
          <div className="mb-8">
            ...
            <p className="text-xl text-gray-600 mb-2">
              We're working hard to bring you our amazing project
            </p>
            
            <p className="text-lg text-gray-500 mb-8">
              Our project section is currently under development and will be available within 3 months
            </p>
          </div>
