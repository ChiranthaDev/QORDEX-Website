...
import { Facebook, Music, Youtube, Linkedin, Github, Instagram, Twitter } from 'lucide-react';
    ...
    <section className="py-12">
      <div className="container mx-auto px-4">
        <div className="grid lg:grid-cols-3 gap-8">
          <div className="lg:col-span-2">
            ...
            <div className="flex flex-col md:flex-row gap-6">
              ...
              <div className="md:w-1/2 cursor-pointer group">
                <div className="relative h-[630px] rounded-lg overflow-hidden mb-4 shadow-xl">
                  <img src="https://images.unsplash.com/photo-1511512578047-dfb367046420?w=800&h=500&fit=crop" alt="Featured" className="w-full h-full object-cover group-hover:scale-105 transition-transform duration-300" />
                  <div className="absolute inset-0 bg-gradient-to-t from-black/80 to-transparent"></div>
                  <div className="absolute bottom-0 left-0 p-6">
                    <h3 className="text-2xl font-bold text-white mb-2 group-hover:text-green-300">Far Cry 6 Game Released.</h3>
                  ...
                  <div key={index} className="cursor-pointer group flex-1">
                    <div className="h-[180px] flex gap-4 bg-white rounded-lg p-4 shadow-md hover:shadow-lg transition-shadow duration-300">
                      <div className="flex-1">
                        <h3 className="text-lg font-bold text-black mb-2 group-hover:text-green-600">{post.title}</h3>
          ...
          <div>
            <div className="bg-white border border-white rounded-lg p-6 mb-6">
            ...
            <div className="bg-slate-900 text-white rounded-lg p-16 mb-6">
              <h3 className="text-xl font-bold mb-6">Daily Newsletter</h3>
              <p className="text-gray-400 text-m mb-6">Discover trending tech stories, innovative projects, and gaming highlights — all in one place. Subscribe now to never miss a tech update.</p>
              <input 
                type="email"
